...
*This configuration is based on [kickstart
modular](https://github.com/dam9000/kickstart-modular.nvim) , a fork of
[nvim-lua/kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim) that
moves from a single file to a multi file configuration.*
